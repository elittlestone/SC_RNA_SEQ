...
<iframe src="results/qc_figures/violin_AL02.png" width="100%" height="400px" style="border:none;"></iframe>

<iframe src="results/qc_figures/scatter_AL02.png" width="100%" height="400px" style="border:none;"></iframe>

<iframe src="results/qc_figures/violin_AL03.png" width="100%" height="400px" style="border:none;"></iframe>

<iframe src="results/qc_figures/scatter_AL03.png" width="100%" height="400px" style="border:none;"></iframe>
...
Next, we want to perform doublet detection. Doublets are droplets which have two or more cells.**
