...
**We can either perform manual cell-type annotation using a pre-defined list of marker genes, or we can use differentially expressed genes as our markers. I decided to use the DE genes as markers. **
