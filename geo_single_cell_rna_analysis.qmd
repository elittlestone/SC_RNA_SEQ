...
### 3.8 Manual Cell-type annotation and Differential Gene Expression Analysis
...
**Cell-type annotation is performed by using a set of marker genes, which are genes that are often highly expressed in a particular cell-type, to label our clusters. I used the scanpy tutorial's marker gene set, which was obtained from the single-cell best practice web book I mentioned earlier.**
